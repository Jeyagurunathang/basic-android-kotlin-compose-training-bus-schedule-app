...
class BusScheduleViewModel(
    ...
    fun getFullSchedule(): Flow<List<BusSchedule>> = busScheduleDao
        .getAllBusStops()
        .stateIn(
    ...
    fun getScheduleFor(stopName: String): Flow<List<BusSchedule>> = busScheduleDao
        .getBusStopDetails(stopName)
        .stateIn(
            scope = viewModelScope,
    ...
    companion object {
        val factory : ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                BusScheduleViewModel(application.getDao)
            }
        }
    }
}
